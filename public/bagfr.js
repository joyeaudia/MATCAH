// bagfr.js — cart renderer + likes + checkout (localStorage per user, no Firestore)
...
// ===== Checkout -> create order & redirect to order.html + WhatsApp (localStorage per user) =====
(function () {
  'use strict';
  ...
  // CHECKOUT: simpan order ke localStorage per user + buka WA + redirect ke Orders
  document.addEventListener('click', function (e) {
    ...
    // save local copy (per user) — ini yang dibaca order.js kita
